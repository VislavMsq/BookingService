...
@Repository
public interface CategoryPriceScheduleRepository extends JpaRepository<CategoryPriceSchedule, UUID> {

    List<CategoryPriceSchedule> findByPriceCategory(PriceCategory priceCategory);
}
