...
@Repository
public interface PriceScheduleRepository extends JpaRepository<PriceCategorySchedule, UUID> {
    List<PriceCategorySchedule> findAllByPriceCategoryAndOwner(PriceCategory priceCategory, User owner);
