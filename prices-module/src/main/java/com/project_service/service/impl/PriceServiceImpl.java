...
import com.project_service.mapper.PriceMapper;
...
public class PriceServiceImpl implements PriceService {
    ...
    @Override
    @Transactional
    public List<PriceDto> getPricesOfApartment(String apartmentId, LocalDate startDate, LocalDate endDate) {
        List<Price> pricesOfApartment = priceRepository.findPricesOfApartment(UUID.fromString(apartmentId),
                startDate, endDate);
    ...
    @Override
    @Transactional
    public void updatePrices(List<String> apartmentIds, LocalDate startDate, LocalDate endDate) {
    ...
    private Optional<PriceCategoryToApartmentCategory> getCategoryToCategoryWithMaxPriority(Apartment apartment,
                                                                                            LocalDate date) {
